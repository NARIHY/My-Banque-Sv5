...
@section('titre', 'Commencer chez nous')
...
<main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          <li><a href="{{route('Connecter.Client.salutation')}}">Acceuil</a></li>
        </ol>
        <h2>Premier pas</h2>
          ...
          <div class="col-lg-8 entries">
            ...
            @forelse ($compte_categorie as $categorie)
                <article class="entry">
                    ...
                    <ul>
                        <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="#">Ma banque</a></li>
                        <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="#"><time datetime="2020-01-01">Jan 1, 2020</time></a></li>
                        <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="#">12</a></li>
                    </ul>
                    </div>
                    ...
                    <div class="read-more">
                        <a href="{{route('Connecter.Client.NouveauMenbre.detailler_linscription', ['nomCategorie' => $categorie->nomCategorie, 'id' => $categorie->id])}}">S'inscrire</a>
                    </div>
                    </div>
            ...
            @empty
                <article class="entry">
                    ...
                    <div class="entry-img">
                    <img src="{{asset('public/assets/img/blog/blog-1.jpg')}}" alt="" class="img-fluid">
                    </div>
